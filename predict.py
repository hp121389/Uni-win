...
class UniRel:
    ...
    def predict(self, text):
        ...
        if isinstance(input_ids, list):
            ...
            attention_mask = torch.tensor(attention_mask) # 把数据转换成pytorch张量
...
if __name__ == "__main__":
    ...
    model_path = "./nyt-checkpoint-final"
    ...
    print(unirel.predict("Several senators asked Mr.Bolton about past statements that contrasted with current administration policies, such as his ridiculing of the Law of the Sea Treaty and especially his support for granting United Nations membership to Taiwan over China 's objections"))
